<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/index\view\user\register.html";i:1498204190;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="wrapper">
        <div class="head">
            <ul>  
                <li><a href="<?php echo url('index/index'); ?>"><img src="__STATIC__/index/image/logo.png" alt="logo"></a></li>
                <li class="divider"></li>
        ...
        <div class="content">
            <form method="post" action="<?php echo url('user/register'); ?>">
                ...
                <p class="pass-form-item">
                    ...
                    <input type="password" name="password_confirm" class="pass-text-input" placeholder="请设置登录密码">
                </p>
                <p class="pass-form-item">
