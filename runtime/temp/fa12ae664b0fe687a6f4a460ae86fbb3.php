<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\featured\index.html";i:1497890509;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\header.html";i:1497836203;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\footer.html";i:1497844136;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
  ...
  <form method="get" action="<?php echo url('featured/index'); ?>">
      ...
      <div class="formControls col-xs-8 col-sm-3"> <span class="select-box">
        <select name="type" class="select">
          ...
          <option value="<?php echo $key; ?>" <?php if($key == $showType): ?>selected = selected<?php endif; ?>><?php echo $vo; ?></option>
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <tbody>
        ...
        <tr class="text-c">
          ...
          <td><img src="<?php echo $vo['image']; ?>" style="width:20%;"></td>
          ...
          <td class="td-manage">
          <a style="text-decoration:none" class="ml-5" onClick="o2o_s_edit('编辑','<?php echo url('featured/edit',['id'=>$vo['id'],'type'=>$vo['type']]); ?>','',300)" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
          <a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('featured/status',['id'=>$vo['id'],'status'=>-1]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
      </tbody>
    </table>
