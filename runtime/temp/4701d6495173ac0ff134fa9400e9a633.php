<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\category\edit.html";i:1492702589;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\header.html";i:1497836203;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\footer.html";i:1497844136;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				...
				<select name="parent_id" class="select">
                    ...
                    <!--加一个判断，用来设置当编辑二级栏目时，在分类栏目中显示它的父级栏目-->
					<option value="<?php echo $vo['id']; ?>"
                                <?php if($category['parent_id'] == $vo['id']): ?>
                            //这里的selected = "selected"是option便签里面的selected属性，表示在页面加载时预先选定该选项
                                    selected="selected"
                                <?php endif; ?>>
                        - <?php echo $vo['name']; ?> -
                    </option>
