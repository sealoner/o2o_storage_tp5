<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\location\index.html";i:1498792081;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\public\header.html";i:1497407984;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\public\footer.html";i:1497844114;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius"  href="<?php echo url('location/add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加分店</a></span> <span class="r"></span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($LocData) || $LocData instanceof \think\Collection || $LocData instanceof \think\Paginator): $i = 0; $__LIST__ = $LocData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					<td><?php echo $vo['id']; ?></td>
					<td><?php echo $vo['name']; ?></td>
					<td><?php echo $vo['create_time']; ?></td>
					<td><?php echo is_main($vo['is_main']); ?></td>
					<td class="td-status"><a href="<?php echo url('location/status',['id'=>$vo['id'],'status'=>$vo['status']==1?0:1]); ?>"><?php echo status($vo['status']); ?></a></td>
