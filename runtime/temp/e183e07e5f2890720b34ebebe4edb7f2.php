<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\featured\edit.html";i:1497890649;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\header.html";i:1497836203;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\footer.html";i:1497844136;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<div class="cl pd-5 bg-1 bk-gray mt-20"> 修改/查看推荐位信息</div>
	...
	<form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('featured/add'); ?>">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $results['title']; ?>" placeholder="" id="" name="title">
			</div>
		</div>
		...
		<div class="row cl">
              ...
              <div class="formControls col-xs-8 col-sm-9">
                ...
                <img style="display: block" id="upload_org_code_img" src="<?php echo $results['image']; ?>" width="150" height="150">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<span class="select-box">
					<select name="type" class="select">
						...
						<option value="<?php echo $key; ?>"<?php if($showType == $key): ?>selected=selected<?php endif; ?>><?php echo $vo; ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $results['url']; ?>" placeholder="" id="" name="url">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $results['description']; ?>" placeholder="" id="" name="description">
			</div>
		</div>
		
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 确定修改</button>	
			</div>
		</div>
	</form>
</article>
