<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\deal\add.html";i:1497514315;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\public\header.html";i:1497407984;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\public\footer.html";i:1497844114;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	...
	基本信息：
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<?php if(is_array($bislocations) || $bislocations instanceof \think\Collection || $bislocations instanceof \think\Paginator): $i = 0; $__LIST__ = $bislocations;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<input name="location_ids[]" type="checkbox" id="checkbox" value="<?php echo $vo['name']; ?>"/><?php echo $vo['name']; endforeach; endif; else: echo "" ;endif; ?>
				</div>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<script id="editor1"  type="text/plain" name="notes" style="width:80%;height:300px;"></script> 
			</div>
		</div>
