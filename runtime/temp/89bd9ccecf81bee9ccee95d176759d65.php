<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"F:\Aaron\GitHub\tp5_o2o\public/../application/index\view\user\login.html";i:1498373980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="content">
            <div class="wrap">
                ...
                <div class="login-area">
                    ...
                    <div class="login">
                        <form method="post" action="<?php echo url('user/logincheck'); ?>">
