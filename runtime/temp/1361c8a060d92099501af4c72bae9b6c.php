<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\index\index.html";i:1495093571;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\header.html";i:1497836203;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\menu.html";i:1497835707;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\footer.html";i:1497844136;}*/ ?>
﻿<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					...
					<li><a data-href="<?php echo url('bis/dellist'); ?>" data-title="删除的商户" href="javascript:void(0)">删除的商户</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('deal/index'); ?>" data-title="团购审核通过列表" href="javascript:void(0)">团购审核通过列表</a></li>
					<li><a data-href="<?php echo url('deal/deallist'); ?>" data-title="商家团购申请列表" href="javascript:void(0)">商家团购申请列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
