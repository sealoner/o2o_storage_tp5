<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\deal\index.html";i:1497585337;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\public\header.html";i:1497407984;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/bis\view\public\footer.html";i:1497844114;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius"  href="<?php echo url('deal/add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加团购商品</a></span> <span class="r"></span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($dealdata) || $dealdata instanceof \think\Collection || $dealdata instanceof \think\Paginator): $i = 0; $__LIST__ = $dealdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
