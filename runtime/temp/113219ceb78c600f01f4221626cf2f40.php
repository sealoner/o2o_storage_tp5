<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"F:\Aaron\GitHub\tp5_o2o\public/../application/index\view\detail\index.html";i:1499674202;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/index\view\public\head.html";i:1499224099;s:72:"F:\Aaron\GitHub\tp5_o2o\public/../application/index\view\public\nav.html";i:1499096213;s:73:"F:\Aaron\GitHub\tp5_o2o\public/../application/index\view\public\foot.html";i:1498985999;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="p-bread-crumb">
            <div class="w-bread-crumb">
                <ul class="crumb-list">
                    ...
                    <li class="crumb"><a><?php echo $categorys['name']; ?></a><span class="ico-gt">&gt;</span></li>
        ...
        <div class="p-item-info">
            <div class="w-item-info">
                ...
                <div class="item-title">
                    <span class="text-main">仅售<?php echo $deal['current_price']; ?>元，价值<?php echo $deal['origin_price']; ?>元精选自助餐1位！免费WiFi！</span>
                </div>
                            ...
                            <a class="link jingxuan-box" alt="更多精选品牌特惠">
                                <div class="box">
                                    <div class="jx-update" id="j-jxUpdateTime">
                                        <?php if($flag == -1): ?>
                                            <span style="background-color: #9e9e9e;">团购已结束</span>
                                        <?php elseif($flag == 1): ?>
                                            <span>距离结束时间还有</span>
                                            <span class="jx-timerbox"><?php echo $endtime; ?></span>
                                        <?php elseif($flag == 0): ?>
                                            <span>距离开始时间还有</span>
                                            <span class="jx-timerbox" style="background-color: #1b66c7;"><?php echo $begintime; ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </a>
                            ...
                            <div class="buy-panel">
                                <div class="validdate-buycount-area static-hook-real static-hook-id-11">
                                    <div class="item-countdown-row">
                                        ...
                                        <span class="value"><?php echo date("Y-m-d",$deal['end_time']); ?></span>
                                    </div>
                                    <div class="item-buycount-row j-item-buycount-row">
                                        ...
                                        <div class="text-wrap">
                                            <span class="left-budget">优惠价剩余<?php echo $surplus; ?>份</span>
                                ...
                                <div class="item-buy-area">
                                    <div style="float:left" class="static-hook-real static-hook-id-12">
                                        ...
                                        <?php elseif($flag === 0): ?>
                                            <a class="btn-buy btn-buy-qrnew j-btn-buy btn-hit" style="background-color: #b4b5b5;border-color: #b4b5b5;">
                                                即将开抢
                                            </a>
                                        <?php elseif($flag === -1): ?>
                                            <a class="btn-buy btn-buy-qrnew j-btn-buy btn-hit" style="background-color: #b4b5b5;border-color: #b4b5b5;">
            ...
            <div class="iim-wrapper">
                ...
                <ul class="j-info-all">
                    <li class="tab">
                        <div class="ia-shop-branch">
                            <div class="w-shop-branch">
                                ...
                                <div class="branch-content">
                                    <div class="shop-map">
                                        <div class="w-map">
                                            <img src="<?php echo url('map/getMapImage',['center'=>$baiduMap]); ?>">
                                        </div>
                                    </div>
                                                ...
                                                <div class="w-branch-list">
                                                    ...
                                                    <?php if(is_array($locationData) || $locationData instanceof \think\Collection || $locationData instanceof \think\Paginator): $i = 0; $__LIST__ = $locationData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                        <li class="branch branch-open">
                                                            ...
                                                            <p class="branch-address">地址：<?php echo $vo['api_address']; ?></p>
                                                            <p class="branch-tel">电话：<?php echo $vo['tel']; ?></p>
                                                        </li>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>    
                                                    </ul>
                                                </div>
                        ...
                        <div class="ifram">本单详情</div>
                    </li>

                    <li class="tab" style="display: block;">
                    <div class="ifram">商家介绍</div>
                    <div class="ifram"><?php echo $deal['description']; ?></div>
                    </li>

                    <li class="tab" style="display: block;">
                    <div class="ifram" style="display: block;">消费提示</div>
                    <div class="ifram"><?php echo $deal['notes']; ?></div>
                    </li>
