<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\bis\detail.html";i:1496648733;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\header.html";i:1497836203;s:75:"F:\Aaron\GitHub\tp5_o2o\public/../application/admin\view\public\footer.html";i:1497844136;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="cl pd-5 bg-1 bk-gray mt-20"> <h1>商户入驻申请审核资料</h1></div>
<article class="page-container">
	...
	基本信息：
		...
		<div class="row cl">
              <label class="form-label col-xs-4 col-sm-2">商家Logo：</label>
              <div class="formControls col-xs-8 col-sm-9">
                <img id="upload_org_code_img" src="<?php echo $bisData['logo']; ?>" width="60%" >
              </div>
        </div>
        <div class="row cl">
              <label class="form-label col-xs-4 col-sm-2">营业执照：</label>
              <div class="formControls col-xs-8 col-sm-9">
                <img id="upload_org_code_img_other" src="<?php echo $bisData['licence_logo']; ?>" width="60%">
              </div>
        </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $locationData['open_time']; ?>" placeholder="" id="" name="open_time">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor"  type="text/plain" name="content" style="width:80%;height:300px;"><?php echo $locationData['content']; ?></script> 
			</div>
		</div>
...
<script>
	//其实只是定义了一个叫做SCOPE的变量，而这个变量为全局域，可以在其他JS代码中被调用
	var SCOPE = {
